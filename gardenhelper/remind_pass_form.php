...
include $siteUrl . '/modules/user/registration/remind_password.php';
?>
...
<head>
	<meta charset="utf-8">
	<title>Garden Helper. Login page</title>
...
<body>
	...
	<div class="login__container _container">
		<form action="" class="login__login-form login-form" method="POST">
			<div class="login-form__form-title">
				Remind password
			</div>
			<div class="registration-form__form-row form-row">
				<div class="form-row__title">Phone</div>
			...
			<div class="registration-form__login">
				<a href="login.php" class="btn-second">Login</a>
			</div>
