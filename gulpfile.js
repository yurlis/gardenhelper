...
let path = {
	...
	src: {
		html: [source_folder + "/**/*.{php,html}", "!" + source_folder + "/_*.html"],
...
function images() {
	// сохраняются и обычные и webp для разных браузеров
		...
		.pipe(svgSprite({
			mode: {
				stack: {
					...
					example: true // надо выключить в продакшн
				}
			},
		}
		))
